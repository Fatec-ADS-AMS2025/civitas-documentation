...
O cenário atual da área contemplada pelo \textit{Civitas} envolve rotinas administrativas e financeiras típicas da gestão pública municipal. Em muitos órgãos públicos, o controle de cadastros, documentos, despesas e informações orçamentárias ainda depende de planilhas eletrônicas, arquivos digitais dispersos, documentos impressos e comunicação entre setores por e-mail ou mensagens informais. Embora esses recursos auxiliem tarefas pontuais, eles não garantem integração completa entre os dados, não oferecem rastreabilidade adequada das alterações e dificultam a consolidação das informações necessárias para análise gerencial.

Atualmente, processos como o registro de despesas, a conferência de documentos, a atualização de cadastros e o acompanhamento de informações orçamentárias podem ocorrer de forma fragmentada. Essa fragmentação gera retrabalho, aumenta a possibilidade de divergências entre versões de documentos, dificulta a localização rápida de registros e limita a visualização do histórico de decisões administrativas. Além disso, a ausência de trilhas de auditoria padronizadas reduz a capacidade de identificar quem realizou determinada alteração, em qual momento e com qual justificativa.

Diante desse contexto, a informatização torna-se necessária para melhorar o fluxo de informações, centralizar registros, reduzir falhas operacionais e apoiar a prestação de contas. Um sistema integrado permite que os setores envolvidos trabalhem com dados consistentes, evita duplicidade de cadastros, facilita consultas e contribui para maior transparência no uso dos recursos públicos. Também favorece a conformidade com princípios de segurança da informação e proteção de dados, especialmente quando há controle de acesso, autenticação de usuários e registro das operações realizadas.

A análise de sistemas concorrentes ou semelhantes é uma etapa importante porque permite identificar soluções já consolidadas no mercado, compreender funcionalidades recorrentes, observar limitações de ferramentas existentes e selecionar boas práticas aplicáveis ao projeto. Ao comparar o problema atual com sistemas disponíveis, torna-se possível definir melhor o escopo do \textit{Civitas}, evitando a reprodução de falhas conhecidas e priorizando recursos compatíveis com a realidade de órgãos públicos de menor porte, que necessitam de uma solução mais objetiva, acessível e adaptada às rotinas essenciais de gestão administrativa.

\subsection{Levantamento de Sistemas no Mercado}

Com o avanço das tecnologias voltadas ao setor público, diversas plataformas passaram a oferecer recursos para planejamento, orçamento, contabilidade, processos digitais, atendimento ao cidadão e gestão documental. Para este levantamento, foram analisados quatro sistemas semelhantes ao escopo do \textit{Civitas}: e-Cidade, Betha Cloud Contábil, GOVBR Cidade 360 e 1Doc. A escolha considerou a aderência dessas soluções aos processos de gestão pública municipal, à centralização de informações e ao controle de documentos ou registros administrativos.

O \textbf{e-Cidade} é um software público voltado à informatização integrada da gestão dos municípios brasileiros, contemplando módulos como financeiro, patrimonial, cidadão, gestor, recursos humanos, educação, saúde e \textit{business intelligence} \parencite{eCidadeSoftwarePublico2026}. Entre seus diferenciais percebidos estão o caráter de software público, a possibilidade de economia de recursos e a liberdade de escolha de fornecedores para implantação e manutenção. Como limitação, trata-se de uma solução ampla, que pode exigir maior esforço técnico de instalação, configuração, treinamento e adaptação à realidade de cada município.

O \textbf{Betha Cloud Contábil} é uma solução em nuvem voltada ao acompanhamento da execução orçamentária e contábil de municípios. A documentação oficial destaca funcionalidades para planejamento e execução de receitas e despesas orçamentárias, controle de alterações orçamentárias, escrituração contábil e movimentação de despesas em um único ambiente \parencite{BethaContabilCloud2026}. O sistema também apresenta integração com módulos como Planejamento e Tesouraria, o que fortalece a comunicação entre rotinas orçamentárias e financeiras. Sua principal limitação, para o contexto do \textit{Civitas}, está no fato de ser uma solução comercial e abrangente, potencialmente mais complexa e onerosa para projetos que buscam uma ferramenta acadêmica, objetiva e de menor escopo.

O \textbf{GOVBR Cidade 360} reúne módulos voltados à gestão pública municipal, incluindo áreas como finanças, planejamento e orçamento, receitas, serviços digitais, suprimentos, gestão e governança \parencite{GovbrCidade3602026}. A plataforma apresenta como pontos fortes a amplitude de módulos, a integração entre produtos e a oferta de recursos voltados ao governo digital. Como limitação, sua abrangência pode exceder as necessidades iniciais do \textit{Civitas}, que prioriza funcionalidades essenciais de controle administrativo, despesas, documentos e auditoria, sem a pretensão de substituir todos os sistemas setoriais de uma prefeitura.

O \textbf{1Doc} é uma plataforma de processos e documentos digitais utilizada por prefeituras e instituições públicas. A solução oferece recursos como processos, documentos, protocolos, memorandos, alvarás, atendimentos, ouvidoria e assinatura digital, buscando reduzir o uso de papel e agilizar fluxos administrativos \parencite{OneDoc2026}. Seu principal diferencial está na digitalização de processos e documentos, com foco em tramitação, formalização e assinatura eletrônica. Entretanto, sua limitação em relação ao \textit{Civitas} é que ela não se concentra especificamente na execução orçamentária ou no controle de despesas, sendo mais aderente à gestão documental e processual.
...
\begin{quadro}[H]
	...
	\begin{tabularx}{\textwidth}{|P{0.16\textwidth}|X|X|X|}
		...
		e-Cidade & Módulos integrados para gestão municipal, incluindo financeiro, patrimonial, cidadão, gestor, recursos humanos, educação, saúde e BI. & Software público, abordagem completa para municípios, possibilidade de redução de custos e uso de tecnologias web. & Pode exigir implantação técnica mais complexa. O \textit{Civitas} terá escopo mais enxuto, priorizando cadastros, despesas, documentos e auditoria. \\ \hline

		Betha Cloud Contábil & Execução orçamentária e contábil, receitas, despesas, alterações orçamentárias, escrituração e movimentação de despesa. & Plataforma em nuvem, integração com Planejamento e Tesouraria, aderência a rotinas contábeis municipais. & Solução comercial e ampla. O \textit{Civitas} busca ser mais simples, acessível e voltado às rotinas administrativas essenciais. \\ \hline

		GOVBR Cidade 360 & Módulos para finanças, planejamento e orçamento, receitas, suprimentos, serviços digitais, gestão e governança. & Grande abrangência funcional, integração entre áreas e recursos de governo digital. & Pode exceder a necessidade inicial do projeto. O \textit{Civitas} propõe uma alternativa objetiva para centralizar dados administrativos e registrar auditorias. \\ \hline

		1Doc & Processos digitais, documentos, protocolos, memorandos, atendimentos, ouvidoria e assinatura digital. & Forte gestão documental, tramitação digital, redução do uso de papel e suporte a assinaturas eletrônicas. & Não é focado em orçamento e controle de despesas. O \textit{Civitas} combina gestão documental com controle administrativo e financeiro. \\ \hline
	\end{tabularx}
...
A comparação evidencia que as soluções existentes possuem funcionalidades relevantes, mas também apresentam diferenças importantes em relação à proposta do \textit{Civitas}. Sistemas como e-Cidade, Betha Cloud Contábil e GOVBR Cidade 360 possuem escopo amplo e maior proximidade com a gestão municipal completa, enquanto o 1Doc se destaca na digitalização de processos e documentos. O \textit{Civitas}, por sua vez, busca reunir em uma solução web mais objetiva os recursos considerados essenciais para o problema identificado: centralização de cadastros, acompanhamento de despesas, organização documental, controle de acesso e registro de auditoria.

Dessa forma, o diferencial do projeto está em propor uma ferramenta direcionada às necessidades mais imediatas da gestão administrativa municipal, com menor complexidade de uso e foco na rastreabilidade das informações. Em vez de competir diretamente com plataformas comerciais completas, o \textit{Civitas} pretende oferecer uma alternativa acadêmica e adaptável, capaz de apoiar setores públicos que necessitam organizar seus processos internos, reduzir dependência de planilhas e documentos dispersos e melhorar a confiabilidade das informações utilizadas na tomada de decisão.
