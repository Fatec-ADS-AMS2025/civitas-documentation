...
O levantamento de requisitos constitui uma das etapas mais relevantes do processo de desenvolvimento de sistemas, uma vez que é nesse momento que se identificam, analisam e documentam as necessidades reais dos usuários e da organização atendida. Essa fase estabelece os fundamentos para a definição precisa do que será construído, garantindo que o produto final esteja em conformidade com as expectativas dos envolvidos e com os objetivos do projeto.  
...
No contexto do \textit{Civitas}, o levantamento de requisitos permitiu identificar necessidades relacionadas à gestão administrativa e financeira de órgãos públicos municipais, tais como a centralização de cadastros, o acompanhamento de despesas, a organização de documentos, o controle de usuários e o registro de auditorias. Essas funcionalidades refletem demandas recorrentes de setores administrativos que precisam de informações consistentes, rastreáveis e disponíveis para apoiar o planejamento, a prestação de contas e a tomada de decisão.  

Conforme destaca \textcite{Sommerville2018ES10}, a definição de requisitos vai além do simples registro de informações iniciais, constituindo um passo essencial para estruturar o ciclo de vida do software e assegurar clareza no que será desenvolvido. Dessa forma, o levantamento realizado neste projeto fornece as bases para a construção de uma solução tecnológica capaz de apoiar a modernização administrativa municipal, reduzindo a fragmentação das informações e fortalecendo o controle interno.  

Portanto, o processo de levantamento de requisitos configura-se como elemento fundamental para garantir que o sistema proposto cumpra seu propósito, ao alinhar as expectativas dos usuários com as funcionalidades implementadas, resultando em uma ferramenta tecnológica que agrega valor e contribui para solucionar as fragilidades identificadas nas rotinas administrativas.
