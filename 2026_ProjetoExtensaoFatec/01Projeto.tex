...
O levantamento de requisitos é uma etapa fundamental no desenvolvimento de software, pois tem como objetivo identificar as necessidades dos usuários e definir as funcionalidades que o sistema deverá oferecer. Essa atividade permite compreender os problemas existentes, os objetivos do projeto e as expectativas dos stakeholders, fornecendo uma base sólida para as demais etapas do desenvolvimento.

De acordo com \textcite{Sommerville2018ES10}, os requisitos de software correspondem às descrições dos serviços que um sistema deve fornecer e às restrições sob as quais deve operar. Esses requisitos servem como referência para a equipe de desenvolvimento, garantindo que o produto final esteja alinhado às necessidades dos usuários e aos objetivos da organização.

Os requisitos podem ser classificados em funcionais e não funcionais. Os requisitos funcionais descrevem os serviços e comportamentos esperados do sistema, enquanto os requisitos não funcionais especificam características relacionadas à qualidade, como desempenho, segurança, confiabilidade e usabilidade. Essa classificação auxilia na organização e na documentação das necessidades identificadas durante o processo de levantamento \parencite{Sommerville2018ES10}.

Segundo \textcite{Pressman2020}, o levantamento de requisitos pode ser realizado por meio de diversas técnicas, como entrevistas, questionários, observação e análise de documentos. A utilização dessas abordagens possibilita uma melhor compreensão do contexto do negócio e contribui para a identificação de requisitos que podem não estar explícitos para os usuários.

Dessa forma, o levantamento de requisitos desempenha um papel essencial no sucesso de projetos de software, pois reduz ambiguidades, minimiza retrabalho e contribui para o desenvolvimento de sistemas que atendam de forma eficaz às necessidades dos usuários. Conforme destacam \textcite{Pressman2020} e \textcite{Sommerville2018ES10}, uma especificação adequada dos requisitos é fundamental para garantir a qualidade e a efetividade do software desenvolvido.

\section{Descrição dos Objetivos do Sistema}

Os fundamentos que orientaram o desenvolvimento do projeto Civitas concretizam-se na criação de um sistema informatizado e integrado, voltado ao gerenciamento da gestão pública municipal. O sistema foi concebido com o propósito de solucionar dificuldades relacionadas ao controle de despesas, orçamentos, instituições e fornecedores da administração pública, especialmente quando esses processos são realizados de forma manual, descentralizada ou pouco eficiente. Tais limitações podem comprometer a organização das informações, a transparência dos dados, o acompanhamento dos recursos públicos e a agilidade na tomada de decisões.

A proposta principal do Civitas consiste em oferecer uma plataforma tecnológica capaz de centralizar e organizar informações essenciais para o planejamento, o controle e o acompanhamento financeiro e administrativo do município. Seus usuários serão, principalmente, gestores públicos, servidores municipais e profissionais responsáveis pelos setores administrativos, financeiros e orçamentários, os quais poderão utilizar o sistema para registrar, consultar e acompanhar dados referentes às despesas, aos orçamentos, às instituições vinculadas e aos fornecedores da administração pública.

A implementação do sistema proporciona benefícios significativos à gestão municipal, como maior controle dos recursos públicos, redução de falhas operacionais, melhoria na rastreabilidade das informações e maior transparência nos processos administrativos. Além disso, o sistema contribui para tornar as atividades internas mais ágeis, organizadas e seguras, favorecendo uma administração pública mais eficiente e responsável perante a sociedade.

A análise das implicações decorrentes do aprimoramento promovido pelo sistema evidencia impactos positivos nos âmbitos organizacional, social e administrativo. Ao modernizar processos antes fragmentados ou dependentes de controles manuais, o Civitas fortalece a capacidade de planejamento e gestão dos órgãos públicos municipais. Como diferencial, destaca-se a integração entre o controle de despesas, orçamentos, instituições e fornecedores em uma única solução, promovendo maior confiabilidade, transparência e eficiência na administração pública.



\section{Análise dos Sistemas Existentes}

O cenário contemplado pelo \textit{Civitas} envolve atividades administrativas e financeiras que, em muitos municípios, ainda são conduzidas com apoio de planilhas, documentos avulsos, arquivos impressos e trocas de informação entre setores por canais pouco padronizados. Esses recursos podem resolver demandas imediatas, mas tendem a limitar a visão integrada dos dados, principalmente quando diferentes equipes precisam consultar cadastros, despesas, documentos e registros orçamentários relacionados a um mesmo processo.

Quando essas rotinas permanecem fragmentadas, surgem dificuldades como retrabalho, divergência entre versões de documentos, demora para localizar registros e baixa clareza sobre o histórico das decisões administrativas. Também se torna mais difícil verificar quem realizou determinada alteração, em que momento ela ocorreu e qual justificativa foi registrada. Por isso, a necessidade de informatização não se restringe à substituição do papel por telas digitais; ela envolve a criação de um fluxo mais controlado, rastreável e confiável para apoiar a prestação de contas e a tomada de decisão.

Nesse contexto, a análise de sistemas existentes contribui para delimitar melhor o escopo do projeto. Ao observar soluções já utilizadas no setor público, é possível identificar padrões de funcionalidades, formas de organização das informações e limitações que não devem ser reproduzidas. Essa comparação também ajuda a posicionar o \textit{Civitas} como uma solução de menor complexidade, voltada às rotinas essenciais de controle administrativo, despesas, documentos e auditoria, sem pretender substituir plataformas completas de gestão municipal.

\subsection{Levantamento de Sistemas no Mercado}

Para o levantamento, foram consideradas quatro soluções relacionadas à gestão pública ou à digitalização de processos administrativos: e-Cidade, Betha Cloud Contábil, GOVBR Cidade 360 e 1Doc. A seleção foi feita pela proximidade dessas ferramentas com temas relevantes ao projeto, como integração de informações, controle financeiro, gestão documental, tramitação de processos e apoio às rotinas de órgãos municipais.

O \textbf{e-Cidade} apresenta uma proposta ampla de informatização da gestão municipal e reúne módulos associados a diferentes áreas da administração pública, como finanças, patrimônio, saúde, educação, recursos humanos e apoio gerencial \parencite{eCidadeSoftwarePublico2026}. Por ser um software público, sua adoção pode reduzir dependência de soluções proprietárias e ampliar a liberdade na escolha de apoio técnico. Em contrapartida, a abrangência da ferramenta pode exigir equipe capacitada, planejamento de implantação e adaptação às normas e processos locais.

O \textbf{Betha Cloud Contábil} concentra-se nas rotinas orçamentárias e contábeis de municípios, com recursos voltados ao acompanhamento de receitas, despesas, alterações orçamentárias e escrituração \parencite{BethaContabilCloud2026}. Essa característica torna a solução mais especializada no controle contábil do que na organização administrativa geral. Para o \textit{Civitas}, a principal referência está na importância de manter dados financeiros consistentes e consultáveis; a diferença é que o projeto busca um escopo acadêmico mais enxuto, sem a profundidade de um sistema contábil completo.

O \textbf{GOVBR Cidade 360} posiciona-se como uma plataforma de gestão municipal com módulos para áreas financeiras, planejamento, receitas, suprimentos, serviços digitais e governança \parencite{GovbrCidade3602026}. A solução evidencia a relevância da integração entre setores, mas também demonstra que plataformas corporativas podem ultrapassar as necessidades iniciais de um projeto voltado a controles administrativos essenciais. Assim, sua análise contribui principalmente para compreender como a centralização de informações pode apoiar a gestão, sem que o \textit{Civitas} precise reproduzir toda a abrangência de uma solução comercial.

O \textbf{1Doc} tem foco na digitalização de processos, documentos e comunicações formais, com recursos voltados à tramitação eletrônica e à assinatura digital \parencite{OneDoc2026}. Essa proposta se aproxima da necessidade de organizar documentos e reduzir fluxos informais, mas não cobre de forma central a execução orçamentária ou o acompanhamento de despesas. Para o \textit{Civitas}, a ferramenta serve como referência para a gestão documental, enquanto o projeto combina esse aspecto com cadastros, controle financeiro e registro de auditoria.

\begin{quadro}[H]
	\centering
	\caption{Comparação entre sistemas existentes e o Civitas}
	\label{quad:comparacao_sistemas_mercado}
	\small
	\begin{tabularx}{\textwidth}{|P{0.16\textwidth}|X|X|X|}
		\hline
		\textbf{Sistema} & \textbf{Principais funcionalidades} & \textbf{Pontos fortes e diferenciais} & \textbf{Limitações e comparação com o Civitas} \\ \hline

		e-Cidade & Gestão municipal integrada, com módulos para áreas administrativas e serviços públicos. & Software público e possibilidade de adaptação por diferentes fornecedores. & Apresenta escopo amplo e implantação mais exigente; o \textit{Civitas} prioriza controles administrativos essenciais. \\ \hline

		Betha Cloud Contábil & Rotinas contábeis e orçamentárias relacionadas a receitas, despesas e escrituração. & Especialização no acompanhamento financeiro municipal. & É mais profundo na área contábil; o \textit{Civitas} utiliza esse tema em um escopo menor e administrativo. \\ \hline

		GOVBR Cidade 360 & Plataforma modular para gestão municipal e serviços digitais. & Integração entre setores e visão ampla da administração pública. & A abrangência pode superar a necessidade do projeto; o \textit{Civitas} foca centralização, despesas, documentos e auditoria. \\ \hline

		1Doc & Tramitação digital de processos, documentos e comunicações oficiais. & Organização documental e formalização eletrônica dos fluxos administrativos. & Tem menor foco em orçamento e despesas; o \textit{Civitas} une gestão documental a controles financeiros básicos. \\ \hline
	\end{tabularx}

	\fonte{Elaborado pelos autores com base em \textcite{eCidadeSoftwarePublico2026}, \textcite{BethaContabilCloud2026}, \textcite{GovbrCidade3602026} e \textcite{OneDoc2026}.}
\end{quadro}

A comparação demonstra que as soluções analisadas atendem a demandas importantes, porém partem de propostas distintas. e-Cidade e GOVBR Cidade 360 procuram cobrir a gestão municipal de forma ampla; Betha Cloud Contábil aprofunda o controle orçamentário e contábil; e 1Doc concentra-se na formalização de documentos e processos. O \textit{Civitas}, por sua vez, combina elementos dessas referências em uma proposta mais delimitada, adequada ao objetivo do projeto: centralizar cadastros, acompanhar despesas, organizar documentos, controlar acessos e registrar ações relevantes em trilhas de auditoria.

Dessa forma, o diferencial do projeto não está em competir diretamente com plataformas completas, mas em oferecer uma alternativa acadêmica, objetiva e adaptável às necessidades imediatas de gestão administrativa municipal. A análise dos sistemas existentes reforça que a simplicidade de uso, a rastreabilidade das informações e a integração mínima entre documentos, despesas e cadastros são pontos essenciais para reduzir dependência de controles dispersos e melhorar a confiabilidade das informações usadas pelos gestores.

\section{Descrição dos Principais Problemas}

Durante o levantamento de requisitos do projeto Civitas, foram identificadas dificuldades relacionadas ao gerenciamento das informações administrativas e financeiras da gestão pública municipal. A situação atual demonstra que processos como controle de usuários, secretarias, instituições, orçamentos, despesas, fornecedores, documentos, fluxos administrativos e auditorias podem ser realizados de forma descentralizada, por meio de registros separados, planilhas ou controles internos sem integração. Esse cenário dificulta a organização dos dados, o acompanhamento das informações e a agilidade na tomada de decisões.

Um dos principais problemas observados é a falta de centralização das informações. Quando os dados estão distribuídos em diferentes locais, aumentam os riscos de inconsistências, duplicidade de registros, perda de informações e retrabalho. Além disso, a ausência de integração limita a visão geral da administração pública, dificultando o acompanhamento entre orçamento disponível, despesas realizadas, instituições atendidas, secretarias responsáveis e fornecedores cadastrados.

Outro problema relevante está relacionado às limitações dos processos atuais de controle e rastreabilidade. O uso de métodos manuais ou pouco automatizados pode gerar atrasos na atualização das informações, falhas operacionais e dificuldade na emissão de relatórios gerenciais. Essa limitação prejudica o acompanhamento das operações realizadas, reduz a transparência dos processos administrativos e dificulta a identificação do histórico de ações executadas no sistema.

Diante dessas dificuldades, justifica-se o desenvolvimento do sistema Civitas, com o objetivo de centralizar informações, reduzir falhas, melhorar o controle administrativo e apoiar a tomada de decisões com base em dados organizados e confiáveis. Dessa forma, a solução proposta contribui para tornar a gestão pública municipal mais eficiente, segura, transparente e adequada às necessidades dos setores administrativos.

\subsection{Descrição dos Requisitos Não Funcionais}

Os requisitos não funcionais determinam as condições de qualidade sob as quais as funcionalidades do sistema devem ser entregues. Diferentemente dos requisitos funcionais, eles não descrevem uma operação isolada, mas estabelecem limites mensuráveis para o comportamento da solução, para a proteção das informações e para a experiência de uso. A ISO/IEC 25010 organiza essas propriedades em um modelo destinado à especificação e à avaliação da qualidade de produtos de software \parencite{ISOIEC25010_2023}. No contexto do \textit{Civitas}, tais propriedades são particularmente relevantes porque decisões administrativas e financeiras dependem de dados disponíveis, íntegros e rastreáveis.

Para reduzir ambiguidades, cada requisito foi associado a um critério de verificação. Os valores apresentados constituem metas iniciais de aceitação e deverão ser aferidos em ambiente de homologação representativo do ambiente de produção. Essa abordagem permite transformar expressões subjetivas, como ``sistema rápido'' ou ``interface simples'', em condições que possam ser verificadas por testes, monitoramento e inspeções técnicas, conforme recomendado para a especificação de requisitos de software \parencite{Sommerville2018ES10}.

\textbf{Desempenho.} Nas operações interativas mais frequentes --- autenticação, consulta, inclusão e atualização de cadastros, despesas e documentos ---, pelo menos 95\% das requisições deverão ser concluídas em até dois segundos. Relatórios e consolidações financeiras poderão demandar até cinco segundos, considerando uma carga de 50 usuários autenticados simultaneamente. A medição deverá ocorrer no servidor, desconsiderando oscilações da conexão do usuário. Paginação, índices nas colunas de busca e consultas que recuperem apenas os dados necessários são decisões técnicas que reduzem consumo de memória e processamento e tornam essa meta sustentável à medida que a base cresce.

\textbf{Segurança.} Todo acesso autenticado deverá empregar contas individuais, autorização por perfil e o princípio do menor privilégio. As comunicações entre navegador e servidor deverão utilizar HTTPS; senhas deverão ser armazenadas somente por meio de função de derivação criptográfica com sal; e os \textit{tokens} de autenticação deverão possuir validade limitada. Eventos de autenticação e alterações em registros administrativos ou financeiros deverão compor uma trilha de auditoria que identifique usuário, data, horário e operação, sem registrar senhas ou segredos. Essas medidas apoiam os princípios de segurança e prevenção e a obrigação de proteção dos dados pessoais estabelecidos pela Lei Geral de Proteção de Dados Pessoais \parencite{brasil2018lgpd}.

\textbf{Disponibilidade.} O \textit{Civitas} deverá permanecer disponível em, no mínimo, 99,5\% do tempo mensal, excetuadas as janelas de manutenção comunicadas previamente. Em um mês de 30 dias, esse índice admite, no máximo, aproximadamente três horas e trinta e seis minutos de indisponibilidade não planejada. A aplicação deverá contar com monitoramento de saúde da API e do banco de dados, além de registro de falhas, para que interrupções sejam detectadas e diagnosticadas. A meta equilibra a continuidade das rotinas municipais com os custos de infraestrutura compatíveis com o escopo do projeto.

\textbf{Escalabilidade.} A solução deverá suportar o dobro da carga inicial --- 100 usuários simultâneos e duas vezes o volume de dados utilizado no ensaio-base --- sem ultrapassar em mais de 20\% os limites de tempo definidos para desempenho. Para viabilizar o crescimento, a API deverá evitar estado de sessão armazenado localmente, as consultas deverão ser paginadas e o banco de dados deverá utilizar índices definidos a partir dos padrões reais de acesso. Desse modo, será possível ampliar os recursos da aplicação ou distribuir instâncias sem reescrever as regras de negócio.

\textbf{Usabilidade.} Os fluxos essenciais deverão apresentar terminologia compatível com a administração municipal, navegação consistente, confirmação para ações destrutivas e mensagens de erro que expliquem como corrigir a entrada. Em testes com representantes dos perfis previstos, pelo menos 85\% dos participantes deverão concluir, sem auxílio do avaliador, as tarefas de consultar um orçamento, registrar uma despesa e localizar um documento. O critério permite avaliar a eficácia da interface com usuários reais, em vez de presumir facilidade de uso apenas a partir da aparência das telas.

\textbf{Acessibilidade.} As páginas e os componentes próprios deverão atender aos critérios de sucesso dos níveis A e AA das WCAG 2.2. Isso inclui operação completa por teclado, foco visível, rótulos programaticamente associados aos campos, alternativas textuais, contraste adequado e redimensionamento do conteúdo sem perda de informação a partir de 320 pixels de largura. As WCAG estruturam a acessibilidade pelos princípios de conteúdo perceptível, operável, compreensível e robusto, além de fornecerem critérios verificáveis por testes automatizados e avaliação humana \parencite{W3CWCAG22_2024}.

\textbf{Integridade dos dados.} O banco de dados deverá impedir registros órfãos, duplicidades em identificadores únicos e valores incompatíveis com as regras de negócio. Para isso, serão utilizadas chaves primárias e estrangeiras, restrições de nulidade e unicidade, tipos numéricos adequados a valores monetários, validação no servidor e transações atômicas nas operações que alterem mais de um registro. Alterações relevantes deverão ser auditáveis. O uso conjunto de restrições e transações preserva a consistência mesmo diante de concorrência ou falha durante uma operação \parencite{Silberschatz2012}.

\textbf{Compatibilidade.} A interface web deverá funcionar nas versões estável corrente e imediatamente anterior dos navegadores Google Chrome, Microsoft Edge e Mozilla Firefox na data de cada entrega. O conteúdo deverá adaptar-se a telas com largura entre 360 e 1920 pixels, sem perda das operações essenciais. Antes de cada versão, os fluxos críticos deverão ser executados na matriz de navegadores e dimensões definida para o projeto, pois testes em um único ambiente não asseguram comportamento equivalente em diferentes mecanismos de renderização.

\textbf{Backup e recuperação.} Deverá ser realizado \textit{backup} completo e automatizado do banco de dados a cada 24 horas, com arquivos criptografados, retenção mínima de 30 dias e armazenamento separado do ambiente principal. O objetivo de ponto de recuperação (RPO) será de, no máximo, 24 horas, e o objetivo de tempo de recuperação (RTO), de até quatro horas após a disponibilização da infraestrutura. A restauração deverá ser ensaiada e registrada ao menos uma vez por trimestre, visto que a existência do arquivo não comprova sua recuperabilidade. A documentação do PostgreSQL recomenda cópias periódicas para dados valiosos e apresenta mecanismos de cópia e restauração que fundamentam esse procedimento \parencite{PostgreSQL18Backup}.

O Quadro~\ref{quad:requisitos_nao_funcionais} consolida os requisitos e os respectivos critérios de aceitação. Os identificadores permitem relacioná-los posteriormente aos casos de teste, aos registros de monitoramento e às decisões de arquitetura.

{
\small
\begin{longquadro}{|P{0.11\textwidth}|P{0.19\textwidth}|P{0.61\textwidth}|}
	\caption{Requisitos não funcionais do Civitas}
	\label{quad:requisitos_nao_funcionais}\\
	\hline
	\textbf{ID} & \textbf{Requisito} & \textbf{Descrição e critério de aceitação} \\ \hline
	\endfirsthead
	...
	\hline
	\multicolumn{3}{l}{\textit{Fonte: elaborado pelos autores (2026).}}
	\endlastfoot

	RNF-01 & Desempenho & Concluir 95\% das operações interativas em até dois segundos e relatórios em até cinco segundos, sob carga de 50 usuários simultâneos. \\ \hline
	RNF-02 & Segurança & Aplicar HTTPS, autenticação com validade limitada, autorização por perfil, armazenamento seguro de senhas e auditoria das operações relevantes, em conformidade com a LGPD. \\ \hline
	RNF-03 & Disponibilidade & Manter disponibilidade mensal mínima de 99,5\%, desconsideradas as manutenções previamente comunicadas, com monitoramento da API e do banco de dados. \\ \hline
	RNF-04 & Escalabilidade & Suportar 100 usuários simultâneos e o dobro do volume do ensaio-base sem exceder em mais de 20\% as metas de tempo de resposta. \\ \hline
	RNF-05 & Usabilidade & Possibilitar que ao menos 85\% dos usuários avaliados concluam, sem auxílio, os três fluxos essenciais definidos para o teste. \\ \hline
	RNF-06 & Acessibilidade & Atender aos critérios A e AA das WCAG 2.2, incluindo teclado, foco, rótulos, contraste, alternativas textuais e adaptação a partir de 320 pixels. \\ \hline
	RNF-07 & Integridade dos dados & Preservar validade, unicidade e relações entre os registros por validações, restrições relacionais, transações e trilha de auditoria. \\ \hline
	RNF-08 & Compatibilidade & Operar nas versões corrente e anterior de Chrome, Edge e Firefox, com interface responsiva entre 360 e 1920 pixels. \\ \hline
	RNF-09 & Backup e recuperação & Executar cópia completa diária, criptografada, separada do ambiente principal e retida por 30 dias, com RPO de 24 horas, RTO de quatro horas e teste trimestral de restauração. \\ \hline
\end{longquadro}
}
...
Os requisitos funcionais descrevem os serviços, as operações e as respostas que devem ser oferecidos pelo sistema aos seus usuários. Conforme \textcite{Sommerville2018ES10}, esse tipo de requisito deve expressar o comportamento esperado da solução diante das entradas recebidas e das situações próprias do domínio. No \textit{Civitas}, sua definição foi realizada a partir das necessidades de organização administrativa, planejamento orçamentário, acompanhamento de despesas e rastreabilidade das ações relacionadas à gestão pública municipal.

A plataforma deverá centralizar informações que, sem um sistema integrado, permaneceriam distribuídas entre planilhas, documentos e setores distintos. Para isso, as funcionalidades foram agrupadas em módulos coerentes com a estrutura do projeto. Os cadastros organizacionais fornecem a base para os lançamentos financeiros; os orçamentos estabelecem os limites e as classificações do planejamento; as despesas registram a execução dos recursos; e os recursos de consulta, exportação e auditoria apoiam o acompanhamento e a prestação de contas. Essa organização reduz a duplicidade de registros e permite que o usuário compreenda os vínculos entre secretarias, instituições, fornecedores, tipos de despesa e movimentações financeiras.

O acesso ao ambiente interno deverá ocorrer mediante autenticação por e-mail e senha. Após a validação das credenciais de um usuário ativo, o sistema emitirá um \textit{token} JWT e manterá a sessão durante seu prazo de validade. As operações da API, exceto o próprio acesso, permanecerão protegidas por autenticação. O cadastro de usuários deverá registrar dados pessoais, endereço, matrícula, situação e tipo de usuário, distinguindo os perfis Visitante, Administrador e Funcionário. A inativação lógica permitirá suspender o acesso sem eliminar o histórico associado ao usuário.

No núcleo administrativo, o sistema deverá manter secretarias municipais, instituições e fornecedores. As instituições serão vinculadas a uma secretaria e a um tipo de instituição, enquanto os fornecedores concentrarão dados de identificação, localização e contato necessários aos lançamentos de despesas e documentos. Cadastros auxiliares de tipos de instituição, tipos de despesa e unidades de medida permitirão configurar classificações reutilizadas nos demais módulos. Para os registros que admitem alteração de situação, a exclusão operacional ocorrerá por ativação ou inativação, preservando os relacionamentos já existentes.

O módulo financeiro deverá possibilitar o registro de orçamentos por exercício, instituição e tipo de despesa. Cada despesa será associada ao orçamento correspondente, à instituição responsável, ao fornecedor, ao tipo de despesa e ao usuário que efetuou o cadastro. Também serão mantidos número do documento, data de emissão, data de vencimento, consumo previsto e, quando exigido pela categoria da despesa, o código da unidade consumidora. Essa vinculação permite confrontar valores orçados e realizados, identificar o saldo disponível e acompanhar a execução financeira por diferentes recortes.

A baixa de uma obrigação deverá ser representada por um fluxo financeiro contendo valor pago, consumo realizado e situação do pagamento, com estados como a pagar, pago ou atrasado. O usuário poderá anexar o comprovante correspondente em formato digital, relacionando o documento ao fornecedor e ao fluxo. No painel inicial, os dados consolidados deverão apresentar total orçado, total gasto, saldo, quantitativos cadastrais, despesas recentes e vencimentos próximos. Os avisos de vencimento exibidos no painel não constituem um serviço externo de notificação; sua finalidade é destacar obrigações que exigem atenção durante o uso da plataforma.

Para apoiar consultas e relatórios operacionais, o sistema deverá oferecer listagens de usuários, despesas, fornecedores, secretarias, instituições e orçamentos. Nessas visualizações, o usuário poderá pesquisar, aplicar filtros, ordenar registros, escolher colunas, paginar resultados e utilizar recortes previamente definidos. A visualização resultante poderá ser exportada nos formatos PDF e XLSX, inclusive com as colunas e os filtros selecionados, facilitando o compartilhamento, a conferência e a elaboração de prestações de contas. Além disso, registros de auditoria poderão ser consultados por usuário, entidade e operação, permitindo identificar a data, o horário e os valores relacionados a uma ocorrência cadastrada.

O Quadro~\ref{quad:requisitos_funcionais} consolida os requisitos funcionais do \textit{Civitas}. A identificação individual favorece a rastreabilidade entre a documentação, as interfaces e os serviços disponibilizados pelos repositórios do projeto.

\small
\begin{longquadro}{|p{0.08\textwidth}|p{0.20\textwidth}|p{0.62\textwidth}|}
	\caption{Requisitos funcionais do sistema Civitas}
	\label{quad:requisitos_funcionais}\\
	\hline
	\textbf{ID} & \textbf{Módulo} & \textbf{Descrição do requisito funcional} \\ \hline
	\endfirsthead
	...
	RF01 & Autenticação & Autenticar o usuário por e-mail e senha, permitindo o ingresso apenas quando as credenciais forem válidas e o cadastro estiver ativo. \\ \hline
	RF02 & Autenticação & Emitir e validar \textit{token} JWT, manter a sessão autenticada até sua expiração e permitir o encerramento da sessão pelo usuário. \\ \hline
	RF03 & Usuários e permissões & Cadastrar, consultar e atualizar usuários, bem como ativar ou inativar seus registros e classificá-los como Visitante, Administrador ou Funcionário. \\ \hline
	RF04 & Usuários e permissões & Consultar usuários ativos e inativos e localizar um cadastro por identificador ou CPF, preservando a relação entre o autor autenticado e as operações registradas. \\ \hline
	RF05 & Estrutura administrativa & Cadastrar, consultar, atualizar e alterar a situação de secretarias, mantendo seus dados de identificação, endereço e contato. \\ \hline
	RF06 & Estrutura administrativa & Cadastrar, consultar, atualizar e alterar a situação de instituições, vinculando cada registro à secretaria responsável e ao respectivo tipo de instituição. \\ \hline
	RF07 & Fornecedores & Cadastrar, consultar, atualizar e alterar a situação de fornecedores e prestadores de serviço, mantendo informações fiscais, comerciais, de endereço e de contato. \\ \hline
	RF08 & Configurações & Gerenciar tipos de instituição, tipos de despesa e unidades de medida, incluindo consulta de ativos e inativos e alteração da situação desses cadastros auxiliares. \\ \hline
	RF09 & Orçamentos & Cadastrar, consultar e atualizar orçamentos, informando exercício, valor, instituição e tipo de despesa ao qual o recurso se destina. \\ \hline
	RF10 & Despesas & Cadastrar, consultar, atualizar e inativar despesas, relacionando-as ao orçamento, à instituição, ao fornecedor, ao tipo de despesa e ao usuário responsável pelo lançamento. \\ \hline
	RF11 & Despesas & Registrar número do documento, emissão, vencimento e consumo previsto e exigir a unidade consumidora quando essa regra estiver configurada para o tipo de despesa selecionado. \\ \hline
	RF12 & Pagamentos & Registrar e atualizar o fluxo de pagamento de uma despesa, incluindo valor efetivamente pago, consumo realizado e estado da obrigação. \\ \hline
	RF13 & Documentos & Cadastrar, consultar e atualizar documentos digitalizados, vinculando comprovantes, notas fiscais ou boletos ao fornecedor e ao fluxo financeiro correspondente. \\ \hline
	RF14 & Painel gerencial & Apresentar total orçado, total gasto, saldo disponível, quantitativos da base, despesas recentes e obrigações vencidas ou com vencimento nos sete dias seguintes. \\ \hline
	RF15 & Consultas & Disponibilizar listagens com pesquisa, filtros, ordenação, paginação, seleção de colunas e recortes predefinidos para os principais cadastros administrativos e financeiros. \\ \hline
	RF16 & Relatórios & Exportar listagens e comparações nos formatos PDF e XLSX, considerando o conjunto de dados, os filtros e as colunas escolhidos pelo usuário. \\ \hline
	RF17 & Auditoria & Cadastrar e consultar ocorrências de auditoria contendo usuário, data, horário, operação, entidade afetada, valores anteriores e novos valores. \\ \hline
	RF18 & Auditoria & Filtrar os registros de auditoria por usuário, entidade ou operação e controlar sua situação para apoiar a rastreabilidade das atividades administrativas. \\ \hline
	RF19 & Perfil & Permitir que o usuário autenticado consulte seus dados de conta, seu e-mail e o perfil associado ao acesso. \\
\end{longquadro}
\normalsize

\fonte{Elaborado pelos autores com base nos repositórios do projeto (2026).}


\input{capitulos/capitulo3}

% Conteúdo legado preservado apenas como referência de estrutura.
% A condição falsa impede sua inclusão no documento final.
\iffalse
\chapter{Modelagem UML do Sistema}

Antes da implementação, decisões sobre limites do domínio, responsabilidades e interações precisam ser registradas de modo que possam ser discutidas pela equipe. A Linguagem de Modelagem Unificada, conhecida como UML, oferece um vocabulário gráfico para esse fim, tornando explícitos os elementos de uma solução computacional e as relações entre eles, especialmente em sistemas compostos por vários módulos e regras de negócio.

De acordo com \textcite{Guedes2018}, a UML é uma linguagem visual utilizada para modelar sistemas, permitindo representar aspectos como requisitos, comportamento, processos e estrutura lógica. Sua utilização possibilita que as características do software sejam analisadas antes e durante sua implementação, contribuindo para a redução de ambiguidades e para o alinhamento entre os integrantes envolvidos no projeto.

A modelagem não busca reproduzir todos os detalhes do sistema, mas apresentar uma abstração de seus elementos mais relevantes. Segundo \textcite{Sommerville2018ES10}, diferentes modelos podem representar perspectivas distintas de uma mesma solução, como sua estrutura, comportamento, contexto e interação. Essa divisão permite analisar o sistema de forma gradual, destacando somente as informações necessárias para cada etapa do desenvolvimento.

A UML também contribui para a comunicação entre os membros da equipe, pois estabelece uma representação padronizada para documentar requisitos e decisões de projeto. Conforme \textcite{PressmanMaxim2021}, sua notação pode ser utilizada tanto na modelagem dos requisitos quanto na representação do projeto do software, auxiliando na transformação das necessidades levantadas em uma estrutura adequada para implementação.

No desenvolvimento do Civitas, os diagramas UML são utilizados para representar os componentes relacionados à gestão pública municipal, permitindo compreender como usuários, secretarias, instituições, orçamentos, despesas, fornecedores, documentos, fluxos e auditorias se organizam dentro do sistema. Essa documentação facilita a validação da solução proposta e contribui para que as regras de negócio sejam implementadas de maneira coerente com o levantamento de requisitos.

Entre os diagramas utilizados no projeto, destaca-se o Diagrama de Classes, apresentado na seção seguinte. Esse diagrama fornece uma visão estrutural do sistema e permite identificar as entidades do domínio, seus atributos, responsabilidades, associações e multiplicidades.

\section{Diagrama de Classes}

Entre os recursos estruturais da UML, o Diagrama de Classes descreve os tipos relevantes do domínio, as propriedades associadas a eles e os vínculos que mantêm entre si. \textcite{Guedes2018} ressalta que esse modelo auxilia a organizar os elementos do sistema e pode orientar a construção de outras representações da UML.

Para \textcite{Sommerville2018ES10}, os diagramas de classes são utilizados na modelagem de sistemas orientados a objetos para representar as classes e suas associações. As multiplicidades adicionadas aos relacionamentos indicam a quantidade de objetos que podem participar de cada associação, permitindo representar regras como relações de um para um e de um para muitos.

A Figura~\ref{fig:diagrama-classes-civitas} apresenta o Diagrama de Classes desenvolvido para o sistema Civitas.

\begin{figure}[p]
	\centering
	\caption{Diagrama de Classes do sistema Civitas}
	\label{fig:diagrama-classes-civitas}
	\includegraphics[
		width=\textwidth,
		height=0.82\textheight,
		keepaspectratio
	]{figs/ClassDiagram.png}
	\fonte{Elaborado pelos autores (2026).}
\end{figure}

O diagrama foi estruturado como um modelo de domínio, priorizando as entidades responsáveis pelo armazenamento e pela organização das informações do Civitas. Embora o backend esteja organizado em camadas, com Controllers, Services e Repositories, o diagrama concentra-se nas classes persistentes e em seus relacionamentos. As regras de aplicação são executadas pelas demais camadas, enquanto as entidades representadas concentram os atributos, estados e vínculos necessários ao funcionamento do sistema.

Na área administrativa, a classe \textit{Secretaria} representa os órgãos responsáveis pelo gerenciamento municipal. Uma secretaria pode administrar diversas instituições, enquanto cada instituição permanece vinculada a uma única secretaria. Essa associação estabelece a hierarquia administrativa do sistema e permite identificar o órgão responsável por cada unidade cadastrada.

A classe \textit{Instituicao} representa as unidades executoras, como escolas, unidades de saúde e outros órgãos públicos. Cada instituição também está associada a um \textit{TipoInstituicao}, responsável por classificá-la conforme sua finalidade. Dessa forma, um mesmo tipo pode ser utilizado para categorizar diversas instituições, enquanto cada instituição possui somente uma classificação.

O planejamento financeiro é representado principalmente pelas classes \textit{Orcamento}, \textit{TipoDespesa} e \textit{UnidadeMedida}. Cada orçamento pertence a uma instituição e corresponde a um determinado exercício, valor disponível e tipo de despesa. Uma instituição pode possuir diversos orçamentos, permitindo separar os recursos de acordo com o período e com a finalidade prevista.

A classe \textit{TipoDespesa} define a categoria dos gastos registrados no sistema. Além da descrição, ela determina a unidade de medida utilizada e informa se o preenchimento de uma Unidade Consumidora é obrigatório. A associação com \textit{UnidadeMedida} permite padronizar valores relacionados a consumo, como quilowatt-hora, metro cúbico ou unidade. Uma unidade de medida pode ser utilizada por diversos tipos de despesa.

No núcleo da execução financeira encontra-se a classe \textit{Despesa}, responsável por representar obrigações, contas e documentos que deverão ser pagos. Cada despesa está vinculada a uma instituição, a um orçamento, a um tipo de despesa, a um fornecedor e ao usuário responsável pelo cadastro. Em sentido inverso, cada uma dessas entidades pode possuir diversas despesas associadas.

Esse conjunto de relacionamentos permite identificar qual instituição originou o gasto, de qual orçamento o valor será descontado, qual categoria foi utilizada, quem receberá o pagamento e qual usuário realizou o lançamento. A estrutura também possibilita acompanhar informações como número do documento, consumo previsto, data de emissão, vencimento e situação cadastral da despesa.

A classe \textit{Fornecedor} representa empresas e prestadores de serviços vinculados às operações financeiras. Seus atributos armazenam informações cadastrais, fiscais e de contato. O relacionamento com as despesas permite manter o histórico dos gastos direcionados a cada fornecedor, enquanto sua associação com os documentos possibilita identificar a origem dos comprovantes, notas fiscais, contratos e boletos armazenados no sistema.

A classe \textit{Fluxo} representa a execução financeira de pagamentos ou medições, registrando o valor pago, o consumo realizado e o estado da operação. O atributo de status permite distinguir fluxos que ainda estão pendentes, que já foram pagos ou que se encontram atrasados. Essa estrutura contribui para o acompanhamento do pagamento e para a comparação entre consumo previsto e realizado.

Os arquivos relacionados à execução financeira são representados pela classe \textit{Documento}. Cada documento possui uma digitalização e um número de identificação, além de estar vinculado ao fornecedor emissor e ao fluxo que comprova. Um fluxo pode apresentar diversos documentos, permitindo reunir os comprovantes necessários para justificar e rastrear determinada operação financeira.

O controle de acesso é representado pela classe \textit{Usuario}, que armazena informações pessoais, credenciais e dados de endereço. O atributo \textit{TipoUsuario} diferencia os níveis de permissão, permitindo separar visitantes, funcionários e administradores. A associação com \textit{Despesa} identifica o responsável por cada lançamento realizado.

A rastreabilidade das operações é complementada pela classe \textit{Auditoria}. Essa entidade registra a data, o horário, o tipo de operação, a entidade afetada, os valores anteriores e os novos valores resultantes da alteração. Cada registro de auditoria está relacionado ao usuário que executou a ação, permitindo identificar responsabilidades e manter um histórico das modificações realizadas no sistema.

As enumerações presentes no modelo, como \textit{Situacao}, \textit{Status}, \textit{TipoUsuario} e \textit{SolicitaUc}, padronizam valores utilizados por diferentes classes. Esses elementos limitam os estados possíveis de cada atributo, reduzem inconsistências e facilitam a aplicação das regras de negócio.

Na leitura do modelo do Civitas, a hierarquia administrativa aparece conectada diretamente aos registros orçamentários e às operações financeiras. As multiplicidades esclarecem quem administra cada instituição, como os recursos se vinculam às despesas e de que forma usuários, fornecedores, documentos e auditorias participam do processo. Assim, o diagrama funciona como um mapa das responsabilidades e dos caminhos de rastreabilidade previstos para o sistema.

\section{Dicionário de Classes}

O \textit{Quadro}~\ref{quad:dicionario-de-dados-da-entidade-tipodespesa} apresenta o dicionário de dados da entidade \textit{TipoDespesa}, responsável por definir as categorias de despesas utilizadas pelo sistema. Seus atributos permitem identificar, classificar e organizar os registros financeiros, além de estabelecer relacionamentos com unidades de medida e despesas cadastradas.

\begin{quadro}[H]
\caption[Dicionário de dados da entidade TipoDespesa]{Dicionário de dados da entidade TipoDespesa}
\label{quad:dicionario-de-dados-da-entidade-tipodespesa}
...
\hline
Despesas & ICollection<Despesa> & Coleção das despesas classificadas por este tipo. \\ 
\hline
\end{tabular}
...
O \textit{Quadro}~\ref{quad:dicionario-de-dados-da-entidade-unidademedida} apresenta o dicionário de dados da entidade \textit{UnidadeMedida}, utilizada para representar as unidades utilizadas na mensuração das despesas. Seus atributos permitem padronizar os registros de quantidade utilizados pelo sistema, garantindo consistência nos cálculos, consultas e relatórios.

\begin{quadro}[H]
\caption[Dicionário de dados da entidade UnidadeMedida]{Dicionário de dados da entidade UnidadeMedida}
\label{quad:dicionario-de-dados-da-entidade-unidademedida}
...
\hline
TiposDespesas & ICollection<TipoDespesa> & Coleção dos tipos de despesas associados à unidade de medida. \\ 
\hline
\end{tabular}
...
O \textit{Quadro}~\ref{quad:dicionario-de-dados-da-entidade-fornecedor} apresenta o dicionário de dados da entidade \textit{Fornecedor}, responsável pelo armazenamento das informações cadastrais dos fornecedores vinculados às despesas registradas no sistema. Seus atributos permitem controlar informações de identificação, contato e relacionamentos com documentos e despesas.

\begin{quadro}[H]
\caption[Dicionário de dados da entidade Fornecedor]{Dicionário de dados da entidade Fornecedor}
\label{quad:dicionario-de-dados-da-entidade-fornecedor}
...
O \textit{Quadro}~\ref{quad:dicionario-de-dados-da-entidade-documento} apresenta o dicionário de dados da entidade \textit{Documento}, responsável pelo armazenamento dos arquivos digitais utilizados como comprovantes das despesas registradas no sistema, tais como notas fiscais, boletos e contratos. Seus atributos permitem associar documentos aos respectivos fornecedores e fluxos financeiros, garantindo maior rastreabilidade das informações.

\begin{quadro}[H]
\caption[Dicionário de dados da entidade Documento]{Dicionário de dados da entidade Documento}
\label{quad:dicionario-de-dados-da-entidade-documento}
...
O \textit{Quadro}~\ref{quad:dicionario-de-dados-da-entidade-secretaria} apresenta o dicionário de dados da entidade \textit{Secretaria}, responsável pelo cadastro dos órgãos administrativos que gerenciam as instituições vinculadas ao sistema. Seus atributos permitem armazenar informações institucionais, de localização e os relacionamentos com as instituições cadastradas.

\begin{quadro}[H]
\caption[Dicionário de dados da entidade Secretaria]{Dicionário de dados da entidade Secretaria}
\label{quad:dicionario-de-dados-da-entidade-secretaria}
...
\hline
Instituicoes & ICollection<Instituicao> & Coleção das instituições vinculadas à secretaria. \\ 
\hline
\end{tabular}
...
O \textit{Quadro}~\ref{quad:dicionario-de-dados-da-entidade-tipoinstituicao} apresenta o dicionário de dados da entidade \textit{TipoInstituicao}, responsável por classificar as instituições cadastradas no sistema conforme sua natureza administrativa. Seus atributos permitem organizar as categorias institucionais utilizadas pelo sistema e seus respectivos relacionamentos.

\begin{quadro}[H]
\caption[Dicionário de dados da entidade TipoInstituicao]{Dicionário de dados da entidade TipoInstituicao}
\label{quad:dicionario-de-dados-da-entidade-tipoinstituicao}
...
Situacao & Situacao & Situação do cadastro. \\ 
\hline
Instituicoes & ICollection<Instituicao> & Coleção das instituições pertencentes a esta categoria. \\ 
\hline
\end{tabular}
...
O \textit{Quadro}~\ref{quad:dicionario-de-dados-da-entidade-instituicao} apresenta o dicionário de dados da entidade \textit{Instituicao}, responsável pelo cadastro das instituições vinculadas às secretarias e utilizadas no gerenciamento das despesas públicas. Seus atributos permitem armazenar informações cadastrais, estabelecer relacionamentos organizacionais e associar despesas, orçamentos e unidades consumidoras.

\begin{quadro}[H]
\caption[Dicionário de dados da entidade Instituicao]{Dicionário de dados da entidade Instituicao}
\label{quad:dicionario-de-dados-da-entidade-instituicao}
...
\hline
Orcamentos & ICollection<Orcamento> & Coleção dos orçamentos da instituição. \\ 
\hline
UnidadesConsumidoras & ICollection<UnidadeConsumidora> & Coleção das unidades consumidoras pertencentes à instituição. \\ 
\hline
Despesas & ICollection<Despesa> & Coleção das despesas registradas para a instituição. \\ 
\hline
\end{tabular}
...
O \textit{Quadro}~\ref{quad:dicionario-de-dados-da-entidade-unidadeconsumidora} apresenta o dicionário de dados da entidade \textit{UnidadeConsumidora}, responsável pelo cadastro das unidades consumidoras pertencentes às instituições. Seus atributos permitem identificar os locais onde são registradas despesas e consumos monitorados pelo sistema, garantindo maior organização dos dados.

\begin{quadro}[H]
\caption[Dicionário de dados da entidade UnidadeConsumidora]{Dicionário de dados da entidade UnidadeConsumidora}
\label{quad:dicionario-de-dados-da-entidade-unidadeconsumidora}
...
\hline
Despesas & ICollection<Despesa> & Coleção de despesas vinculadas à unidade consumidora. \\ 
\hline
\end{tabular}
...
O \textit{Quadro}~\ref{quad:dicionario-de-dados-da-entidade-orcamento} apresenta o dicionário de dados da entidade \textit{Orcamento}, responsável por armazenar os valores orçamentários destinados às instituições para determinados tipos de despesas durante um exercício financeiro. Seus atributos permitem controlar os recursos disponíveis e relacioná-los às despesas cadastradas.

\begin{quadro}[H]
\caption[Dicionário de dados da entidade Orcamento]{Dicionário de dados da entidade Orcamento}
\label{quad:dicionario-de-dados-da-entidade-orcamento}
...
\hline
Despesas & ICollection<Despesa> & Coleção das despesas vinculadas ao orçamento. \\ 
\hline
\end{tabular}
...
O \textit{Quadro}~\ref{quad:dicionario-de-dados-da-entidade-despesa} apresenta o dicionário de dados da entidade \textit{Despesa}, considerada uma das principais entidades do sistema, pois concentra as informações referentes aos gastos registrados pelas instituições. Seus atributos permitem armazenar dados financeiros, datas, fornecedores, documentos e demais relacionamentos necessários para o controle das despesas públicas.

\begin{quadro}[H]
\caption[Dicionário de dados da entidade Despesa]{Dicionário de dados da entidade Despesa}
\label{quad:dicionario-de-dados-da-entidade-despesa}
...
O \textit{Quadro}~\ref{quad:dicionario-de-dados-da-entidade-usuario} apresenta o dicionário de dados da entidade \textit{Usuario}, responsável pelo cadastro dos usuários autorizados a utilizar o sistema. Seus atributos permitem armazenar informações de identificação, autenticação e controle de acesso às funcionalidades disponíveis.

\begin{quadro}[H]
\caption[Dicionário de dados da entidade Usuario]{Dicionário de dados da entidade Usuario}
\label{quad:dicionario-de-dados-da-entidade-usuario}
...
O \textit{Quadro}~\ref{quad:dicionario-de-dados-da-entidade-auditoria} apresenta o dicionário de dados da entidade \textit{Auditoria}, responsável pelo registro das operações realizadas pelos usuários durante a utilização do sistema. Seus atributos permitem manter um histórico das alterações efetuadas, garantindo rastreabilidade e segurança das informações.

\begin{quadro}[H]
\caption[Dicionário de dados da entidade Auditoria]{Dicionário de dados da entidade Auditoria}
\label{quad:dicionario-de-dados-da-entidade-auditoria}
...
O \textit{Quadro}~\ref{quad:dicionario-de-dados-da-entidade-tipocodigo} apresenta o dicionário de dados da entidade \textit{TipoCodigo}, responsável pelo cadastro dos códigos utilizados na classificação das despesas. Seus atributos permitem padronizar a identificação dos códigos empregados no sistema, facilitando sua organização e utilização nos registros financeiros.

\begin{quadro}[H]
\caption[Dicionário de dados da entidade TipoCodigo]{Dicionário de dados da entidade TipoCodigo}
\label{quad:dicionario-de-dados-da-entidade-tipocodigo}
...
\hline
Despesas & ICollection<Despesa> & Coleção de despesas associadas ao tipo de código. \\ 
\hline
\end{tabular}
...
O \textit{Quadro}~\ref{quad:dicionario-de-dados-do-enum-situacao} apresenta o dicionário de dados do enum \textit{Situacao}, utilizado para representar o estado cadastral das entidades presentes no sistema. Seus valores permitem identificar quais registros estão disponíveis ou desativados.

\begin{quadro}[H]
\caption[Dicionário de dados do enum Situacao]{Dicionário de dados do enum Situacao}
\label{quad:dicionario-de-dados-do-enum-situacao}

\begin{tabular}{|p{0.22\textwidth}|p{0.18\textwidth}|p{0.50\textwidth}|}
\hline
\textbf{Valor} & \textbf{Tipo} & \textbf{Descrição} \\ 
\hline
...
O \textit{Quadro}~\ref{quad:dicionario-de-dados-do-enum-solicitauc} apresenta o dicionário de dados do enum \textit{SolicitaUC}, utilizado para indicar se um determinado tipo de despesa exige a seleção de uma unidade consumidora durante o cadastro.

\begin{quadro}[H]
\caption[Dicionário de dados do enum SolicitaUC]{Dicionário de dados do enum SolicitaUC}
\label{quad:dicionario-de-dados-do-enum-solicitauc}
...
O \textit{Quadro}~\ref{quad:dicionario-de-dados-do-enum-tipousuario} apresenta o dicionário de dados do enum \textit{TipoUsuario}, responsável por definir os níveis de acesso disponíveis aos usuários do sistema. Seus valores permitem controlar as permissões de utilização da aplicação.

\begin{quadro}[H]
\caption[Dicionário de dados do enum TipoUsuario]{Dicionário de dados do enum TipoUsuario}
\label{quad:dicionario-de-dados-do-enum-tipousuario}
...
O \textit{Quadro}~\ref{quad:dicionario-de-dados-do-enum-status} apresenta o dicionário de dados do enum \textit{Status}, responsável por representar a situação das despesas cadastradas no sistema. Seus valores permitem acompanhar o andamento dos registros financeiros.

\begin{quadro}[H]
\caption[Dicionário de dados do enum Status]{Dicionário de dados do enum Status}
\label{quad:dicionario-de-dados-do-enum-status}
...
A identificação dos atores permite reconhecer quem interage com o sistema e quais objetivos cada participante busca alcançar por meio das funcionalidades oferecidas. Na modelagem de casos de uso, um ator representa um papel desempenhado por uma pessoa ou por outro elemento externo durante sua interação com a solução, não correspondendo necessariamente a um indivíduo específico \parencite{Guedes2018}. No contexto do \textit{Civitas}, foram identificados três perfis de interação: Administrador, Funcionário e Visitante. Administrador e Funcionário utilizam recursos internos após a autenticação, enquanto o Visitante permanece limitado às operações públicas de acesso.

O ator abstrato \textit{Usuário}, representado na Figura~\ref{fig:atores}, reúne as interações de acesso compartilhadas pelos três perfis, como informar as credenciais para solicitar autenticação e solicitar a redefinição da senha. Esse ator não representa um quarto perfil de acesso; sua utilização no diagrama evita a repetição desses comportamentos e demonstra a relação de generalização com Administrador, Funcionário e Visitante. As demais funcionalidades são disponibilizadas somente conforme as permissões atribuídas ao perfil identificado.

O \textit{Administrador} representa o gestor responsável pela configuração, supervisão e manutenção dos dados do \textit{Civitas}. Esse ator possui o maior nível de permissão e pode gerenciar usuários, atribuir perfis, ativar ou inativar cadastros e manter secretarias, instituições, fornecedores e configurações auxiliares. Também pode cadastrar e atualizar orçamentos e despesas, registrar pagamentos, associar documentos comprobatórios, consultar o painel gerencial, utilizar a central de listagens, exportar informações e acompanhar registros de auditoria. Sua atuação assegura que a estrutura administrativa e as informações financeiras permaneçam organizadas e disponíveis aos demais usuários.

O \textit{Funcionário} representa o servidor municipal ou profissional que executa rotinas administrativas, financeiras e orçamentárias. Suas principais interações abrangem a consulta dos cadastros necessários ao trabalho, o registro e a atualização de despesas, a verificação dos orçamentos disponíveis, o lançamento de pagamentos e a inclusão de comprovantes. Esse ator também pode acompanhar despesas recentes e vencimentos, utilizar mecanismos de pesquisa e filtragem, consultar listagens e gerar exportações relacionadas às atividades sob sua responsabilidade. Diferentemente do Administrador, o Funcionário não é responsável pela administração dos usuários nem pela definição das configurações estruturais do sistema.

O \textit{Visitante} corresponde ao usuário que ainda não possui acesso às áreas internas do \textit{Civitas}. Suas interações restringem-se ao envio de uma solicitação de login, mediante o fornecimento de e-mail e senha, e ao envio de uma solicitação de redefinição de senha para o endereço eletrônico associado ao cadastro. Esse ator não pode visualizar o painel, consultar registros, acessar dados de perfil ou executar operações de cadastro, atualização, inativação e exclusão. O simples envio da requisição de login não concede acesso às funcionalidades protegidas, pois a liberação depende da validação das credenciais e das permissões do perfil reconhecido pelo sistema.

A Figura~\ref{fig:atores} apresenta a relação de generalização entre os atores. As setas partem dos perfis específicos e apontam para o ator abstrato Usuário, indicando que Administrador, Funcionário e Visitante compartilham as interações iniciais relacionadas às credenciais, mas possuem permissões distintas após a identificação. O próprio \textit{Civitas} não é representado como ator, pois constitui o sistema que está sendo modelado, e não um elemento externo que interage com ele.

\begin{figure}[H]
	\centering
	\caption{Diagrama de atores do sistema Civitas}
	\includegraphics[width=0.85\textwidth]{figs/atores_civitas.png}
	\label{fig:atores}
	\fonte{Elaborado pelos autores (2026).}
\end{figure}
